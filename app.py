...
# ── ROW 1: Price + Room Type ──────────────────────────────
st.markdown('<div class="section-header">📊 Price & Supply Analysis</div>', unsafe_allow_html=True)
col1, col2 = st.columns([3, 2])
...
# ── ROW 3: MARKET SEGMENTS ────────────────────────────────
st.markdown("---")
st.markdown('<div class="section-header">🔍 Market Segmentation — K-Means (K=4)</div>', unsafe_allow_html=True)
...
# ── ROW 4: SENTIMENT ──────────────────────────────────────
st.markdown("---")
st.markdown('<div class="section-header">💬 Guest Sentiment Analysis — VADER NLP (80K reviews)</div>', unsafe_allow_html=True)
...
# ── MAP ────────────────────────────────────────────────────
st.markdown("---")
st.markdown('<div class="section-header">🗺️ Listing Map — Geographic Distribution</div>', unsafe_allow_html=True)
